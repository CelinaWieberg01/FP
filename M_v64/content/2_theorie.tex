...
\begin{wrapfigure}{r}{0.50\textwidth}
    ...
    \caption{Two interference patterns with different contrast $C$. On the left, $C$ is high. On the right $C$ is low.}
    \label{fig:contrast}
\end{wrapfigure}
...
can be fitted to obtain $n$ at standard conditions. 