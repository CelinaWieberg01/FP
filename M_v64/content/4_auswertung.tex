...
The measurements for the pressure dependent count of fringes as well as the corresponding refractive index differences are listed in \autoref{tab:meas1}, \autoref{tab:meas2} and \autoref{tab:meas3} .
