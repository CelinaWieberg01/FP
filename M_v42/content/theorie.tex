...
Für kontextbezogene Betrachtungen der STM‑Messung sind die reellen Basisvektoren der zweidimensionalen Bravais‑Gitterdarstellung und die zugehörigen reziproken Gittervektoren nützlich. Eine gebräuchliche Wahl der reellen Basisvektoren lautet
\begin{equation}
\mathbf{a}_1 = a\,(1,0),\qquad 
\mathbf{a}_2 = a\Big(\tfrac{1}{2},\tfrac{\sqrt{3}}{2}\Big),
\end{equation}
wobei die Einheitszelle zwei Basisatome (Sublattice A und B) enthält. Die zugehörigen reziproken Basisvektoren ergeben sich aus \(\mathbf{a}_i\cdot\mathbf{b}_j=2\pi\delta_{ij}\) und können in der obigen Koordinatendarstellung geschrieben werden als
\begin{equation}
