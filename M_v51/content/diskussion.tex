...
Der lineare Fit in \autoref{fig:dif} passt sehr gut zu den Messdaten.
...
ist verglichen mit anderen berechneten Abweichungen groß. Das ist damit zu begründen, dass das entstehende Rechtecksignal des Schmitt-Triggers Unstetigkeiten schräg ansteigende Flanken besitzt, wie in \autoref{fig:schm} erkennbar ist.
...
Die Abweichungen in $T$ von \qty{0.00628}{\second} mit \qty{0.00536(16)}{\second} bzw. \qty{0.00542(25)}{\second} betragen $\qty{15}{\percent}$ bzw. $\qty{14}{\percent}$.
