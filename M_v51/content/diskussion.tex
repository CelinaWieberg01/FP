...
Die gemessenen Verstärkungsfaktoren mit den dazugehörigen Bandbreiten betragen \num{88.0(7)} mit \qty{1.1(5)e4}{\hertz}, \num{11.2(1)} mit \qty{0.5(1.9)e5}{\hertz} und \num{106.0(4)} mit \qty{8.0(3.3)e3}{\hertz}. Die Abweichungen der Verstärkungsfaktoren um jeweils $\qty{12}{\percent}$, $\qty{12}{\percent}$ und $\qty{29}{\percent}$ von den Theoriewerten von $100$, $10$ und $150$
sind nicht groß. Die Abweichungen sind entweder auf Ungenauigkeiten der benutzten Widerstände oder auf unbeachtete Impedanzen im Bredboard zurückzuführen. Die Bandbreiten nehmen mit größerer Verstärkung ab und kleinerer Verstärkung zu.
...
Der lineare Fit in \autoref{fig:dif} passt allerdings sehr gut zu den Messdaten. Eine mögliche Fehlerquelle ist die Sensitivität des Differentiators. Die aufgenommenen Bilder ikn \autoref{fig:dif_sin}, \ref{fig:dif_recht} und \ref{fig:dif_drei} zeigen verglichen
mit dem Integrator starkes Rauschen, was einen Einfluss auf die gemessenen Verstärkungen haben könnte.
...
ist verglichen mit anderen berechneten Abweichungen groß. Das ist damit zu erklären, dass das vom Schmitt-Trigger erzeugte Rechtecksignal schräg ansteigende Flanken statt glatte Unstetigkeiten besitzt, wie in \autoref{fig:schm} erkennbar ist. Die vom Signalgenerator erzeugte Rechteckspannung, zu sehen in \autoref{fig:dif_recht}, besitzt im Vergleich keine Flanken.
