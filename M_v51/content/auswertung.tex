...
Gemäß \autoref{eq:integrator} wird $f$ in $\omega = 2 \pi f$
umgerechnet und $A$ gegen das inverse $\omega$ geplottet. Mit einem linearen Fit der Form
\begin{equation}
...
\begin{figure}[H]
    ...
    \caption{Die Sinusspannung wird zu einer negativen Cosinusspannung integriert.}
    \label{fig:dif_sin}
\end{figure}
