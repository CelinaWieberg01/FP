...
%%% FEHLERBEREICHE DER MESSGERÄTE NENNEN

%%% FEHLERRECHNUNG DER FORMELN EINMAL AUFZEIGEN UND FÜR EINEN WERT NACHRECHNEN
...
Die für die Geraden benutzten Intervalle der Daten lauten dabei
\begin{align}
    %%%%%%%%%% HIER INTERVALLE EINFÜGEN
\end{align}
...
\end{equation}
wobei nur die Werte für die Zeiten von %%%%%%%%%%% HIER ZEITEN NACHSCHLAGEN
