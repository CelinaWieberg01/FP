...
da die Prozesse reversibel sind, die Moleküle können also wieder freigesetzt werden. Diesen Prozess werden als Desorption bezeichnet. Die
...
Wird ein ein System, welches mit einer Pumpe Evakuiert wird, betrachtet, ändert sich der Druck über die Zeit, 
...
\end{equation}
Dabei ist \(p_0\) der Anfangsdruck. Unter berücksichtigung des Enddrucks $p_\text{E}$ modifiziert sich die Lösung zu:
\begin{equation}
...
werden allerdings nicht beide Typen in einem Gerät vereint, sonder wählt nach Anforderungen an den Versuch welches
...
an der Membran befindet kann die Verformung der Membran in ein elektrisches Signal übersetzen. Dieser Effekt wird piezoelektrischer Effekt, 
