...
Grobvakuum bei $\SI{1}{\bar}$ bis $\SI{10^{-3}}{\bar}$, Feinvakuum von $\SI{10^{-3}}{\bar}$ bis $\SI{10^{-7}}{\bar}$, Hochvakuum von $\SI{10^{-7}}{\bar}$ bis $\SI{10^{-9}}{\bar}$ und
das Hochvakuum liegt bei Werten unter $\SI{10^{-9}}{\bar}$.
