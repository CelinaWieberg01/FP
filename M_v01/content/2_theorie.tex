...
Die mittlere Zeit, in der Myonen existieren, ist die sogenannte mittlere Lebensdauer $\tau$. Sie ist verknüpft mit der Halbwertszeit $\tau_{1/2}$ über
\begin{equation*}
    \tau_{1/2} = \tau \cdot \ln(2).
\end{equation*}
Für Myonen beträgt $\tau = \SI{2.196}{\micro\second}$ \cite{myonen}. Nach klassischer Rechnung wären also keine Myonen auf der Erdoberfläche messbar, da diese mit beinahe Lichtgeschwindigkeit in nur ungefähr 2 Mikrosekunden eine Strecke von wenigen hundert Metern zurücklegen.
