...
Dieser Sachverhalt ist in \autoref{fig:delayskizze} dargestellt. Es wird jener Delay gewählt, der den höchsten Überlapp, also den höchsten Count produziert, da die Signale dann gleichzeitig ankommen.
...
Die Messung läuft für ungefähr 48 Stunden.
