...
Verunreinigungen; organische Kristalle sind mechanisch widerstandsfähig; Edelgase haben sehr schnelle Fluoreszenzzeiten von unter einer nanosekunde.
...
Über Photomultiplier ist es möglich, schwache Signale zu verstärken.
...
Über eine Verzögerungsschaltung (Delay) (C) kann die Verzögerung zwischen zwei Signalen für die Coincidence-Schaltung (D) reguliert werden. Die Coincidence-Schaltung gibt ein Signal nur dann, wenn beide Inputs gleichzeitig antreffen.
